...
class RelacaoV(Tk_function):
    def __init__(self, root):
        ...
        self.button_1 = Button(
            ...
            command = Tk_function.relacaoV_button01,
            relief="flat"
        )
        ...
        self.button_2 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command = Tk_function.relacaoV_button02,
            relief="flat"
        )
        ...
        self.button_3 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command = Tk_function.relacaoV_button03,
            relief="flat"
        )
        ...
        self.button_4 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command = Tk_function.relacaoV_back,
            relief="flat"
        )
