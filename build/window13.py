...
class TreinamentoAt(Tk_function):
    def __init__(self, root):
        ...
        self.rectangle = PhotoImage(file = Tk_function.assets("image2_2.png")) #rectangle
        ...
        self.button_1 = Button(
            ...
            command = Tk_function.active_coaching_back,
            relief = "flat"
        )
        ...
        self.image_image_3 = PhotoImage(file = Tk_function.assets("image_3.png"))
