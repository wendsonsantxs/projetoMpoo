...
class CadastroF():
    def __init__(self):
        ...
        self.canvas = Canvas( self.root, bg = "#FFFFFF", height = 825, width = 980, bd = 0, highlightthickness = 0, relief = "ridge")
        ...
        self.entry_image_5 = PhotoImage(file=self.assets("entry4_3.png")) # cargo
        ...
        self.entry_image_6 = PhotoImage(file=self.assets("entry4_3.png")) # departamento
