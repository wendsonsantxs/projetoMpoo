...
from ui.treinamentos.pesquisar.ativos import TreinamentoAt
from ui.treinamentos.pesquisar.historico import HistoricoT
from ui.treinamentos.pesquisar.treinamento import TreinamentoPesquisar
...
class PesquisarWindow(Window):
    def __init__(self, root = Tk):
        ...
        WindowState.set_window(WindowState.ID_PESQUISAR_TREINAMENTO, TreinamentoPesquisar(root=self.root))
    ...
    def button_P1(self):
        self.switch_window(WindowState.get_window(WindowState.ID_PESQUISAR_TREINAMENTO))
