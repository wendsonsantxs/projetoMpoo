...
class FuncionarioP(Window):
    ...
    def create(self):
        ...
        self.canvas.create_text(
            ...
            fill="#FFFFFF",
            font=("IBMPlexSansCond Regular", 31 * -1))
        ...
        self.entry_placeholder = "Digite o ID do funcionário"
    ...
    def button_back(self):
        self.switch_window(WindowState.get_window(WindowState.ID_PESQUISA_F))
