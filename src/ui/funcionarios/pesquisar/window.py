...
from ui.funcionarios.pesquisar.funcionario import FuncionarioP
from ui.funcionarios.pesquisar.banco import BancoF

class PesquisarF(Window):
    def __init__(self, root = Tk):
        super().__init__(root)
        WindowState.set_window(WindowState.ID_FUNCIONARIO_PESQUISAR, FuncionarioP(root=self.root))
        WindowState.set_window(WindowState.ID_BANCO_F, BancoF(root=self.root))
    ...
    def create(self):
        ...
        self.button_1.place(x=499.0,  y=364.0, width=172.0, height=60.0)
        ...
        self.button_2.place(x=499.0, y=544.0, width=172.0, height=60.0)
    ...
    def button_P1(self):
        self.switch_window(WindowState.get_window(WindowState.ID_FUNCIONARIO_PESQUISAR))

    def button_P2(self):
        self.switch_window(WindowState.get_window(WindowState.ID_BANCO_F))
