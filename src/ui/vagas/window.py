...
from ui.vagas.ativas import VagasA
from ui.vagas.banco_talento import BancoT
from ui.vagas.cadastro import CadastroV

class VagasWindow(Window):
    def __init__(self, root: Tk):
        super().__init__(root)
        WindowState.set_window(WindowState.ID_VAGA_ATIVA, VagasA(root=self.root))
    ...
    def relacaoV_button02(self):
        self.switch_window(swap_to=WindowState.get_window(WindowState.ID_VAGA_ATIVA))

    def relacaoV_button03(self):
        self.switch_window(swap_to=WindowState.get_window(WindowState.ID_BANCO_TALENTO))
